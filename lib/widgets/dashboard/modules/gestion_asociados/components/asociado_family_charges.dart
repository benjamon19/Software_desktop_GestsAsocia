...
class AsociadoFamilyCharges extends StatelessWidget {
  final Map<String, dynamic> asociado;

  const AsociadoFamilyCharges({
    super.key,
  ...
  Widget build(BuildContext context) {
    final cargas = asociado['cargasFamiliares'] as List<dynamic>? ?? [];
          ...
          if (cargas.isEmpty)
            ...
            ConstrainedBox(
              ...
              child: Container(
                decoration: BoxDecoration(
                  border: Border.all(
                    color: AppTheme.getBorderLight(context).withOpacity(0.5),
                  ),
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Scrollbar(
