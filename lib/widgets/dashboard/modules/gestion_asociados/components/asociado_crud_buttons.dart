...
class AsociadoCrudButtons extends StatelessWidget {
            ...
            child: Column(
              children: [
                ...
                _buildActionButton(
                  ...
                  subtitle: 'Generar carnet del asociado',
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('Carnet Simple'),
              subtitle: const Text('Carnet básico con datos principales'),
              onTap: () => Navigator.pop(context),
            ),
            ListTile(
              leading: const Icon(Icons.qr_code, color: AppTheme.primaryColor),
              title: const Text('Carnet con QR'),
              subtitle: const Text('Carnet con código QR incluido'),
              onTap: () => Navigator.pop(context),
            ),
          ],
        ),
